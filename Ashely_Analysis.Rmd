---
title: "Ashley Madison sentiment analysis"
...
```{rwarning=FALSE,fig.width=18,fig.height=12,cache=TRUE}
bigramplot(Ash)
```
...
```{r,warning=FALSE,fig.width=12,fig.height=22,cache=TRUE}
Ash=read.csv("C:/Users/Jay/Desktop/Prof.Mike/Ashley Madison/Ashley10k.csv", stringsAsFactors = FALSE)
